...
public class BoardDAO {
	...
	public void insertBoard(BoardVO vo) {
		...
		try {
			conn = JDBCUtil.getConnection();	// Connection 객체 호출 
	...
	public void updateBoard(BoardVO vo) {
		System.out.println("==> JDBC 로 updateBoard() 기능 처리됨");
		try {
	...
	public void deleteBoard(BoardVO vo) {
		System.out.println("==> JDBC 로 deleteBoard() 기능 처리됨");
		try {
			conn = JDBCUtil.getConnection();
	...
	public BoardVO getBoard(BoardVO vo) {
		System.out.println("==> JDBC 로 getBoard() 기능 처리됨");
		BoardVO board = null;
		...
		try {
			...
			if (rs.next()) {		// select 한 결과값이 존재 한다면, rs 의 값을 board 에 Setter 주입 
				board = new BoardVO(); 
	...
	public List<BoardVO> getBoardList(BoardVO vo) {
		System.out.println("==> JDBC 로 getBoardList() 기능 처리됨");
		...
		try {
			...
			while (rs.next()) {		//DB에서 Select 한 결과 값을 VO에 저장해서 
				...
				boardlist.add(board);		//board 를 ArrayList에 저장 
