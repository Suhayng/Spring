		...
		/*
			결합도를 낮추는 2가지 방법
				...
				3. Spring 프레임워크에서 객체를 생성 후 주입하는 방법 
				 	...
				 	- DI (의존성 주입) : 객체를 자바 코드 내부에서 생성하지 않고 Spring 프레임워크에서 
				 					  객체를 생성 후 객체를 자바 코드 내부로 주입한다. 
		*/
		
		AbstractApplicationContext factory = 
				new GenericXmlApplicationContext("applicationContext.xml");
		
			//GenericXmlApplicatoinContext : Bean 설정 파일을 로드함 
		...
		//스프링 컨테이너로 부터 하나의 객체를 여러번 요청 할 수 있다. 
		System.out.println("=====================");
